...
if 'PrinterPrx' not in _M_Demo.__dict__:
    ...
    class PrinterPrx(Ice.ObjectPrx):
        ...
        def countCharacters(self, s, context=None):
            return _M_Demo.Printer._op_countCharacters.invoke(self, ((s, ), context))

        def countCharactersAsync(self, s, context=None):
            return _M_Demo.Printer._op_countCharacters.invokeAsync(self, ((s, ), context))

        def begin_countCharacters(self, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Printer._op_countCharacters.begin(self, ((s, ), _response, _ex, _sent, context))
